$(function() {
    ...
    function createMultipleChoiceOptions(n) {
        ...
        for (var i = 0; i < n; i++) {
            ...
            var option = $('<fieldset class="form-group mc-text-entry"><div class="input-group input"><input type="text" class="form-control" id="q-mc-option-' + i + '" placeholder="Option ' + (i + 1) + ' Text">' +
